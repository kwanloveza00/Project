...
$num+=$payment;
 ...
 <table class="table table-hover">
	...
	<!--  -->
<?php
	$deal_query = db()->query('SELECT dealingId, customerId, productId, balances, seleDate FROM dealing ORDER BY dealingId ASC');
echo db()->error;
while(list($dealingId, $customerId, $productId, $balances, $seleDate) = $deal_query->fetch_row())
{
